    ...
    React.useEffect(() => {
        if (graduateSmallGroup) {
            setFormData({
                ...
                provinceId: graduateSmallGroup.provinceId || "",
            })
        }
    }, [graduateSmallGroup])
                ...
                <div className="container mx-auto max-w-2xl py-8">
                    <SheetHeader className="pb-8 text-center">
                        ...
                        <SheetDescription className="text-lg text-muted-foreground">
                            Update information for {graduateSmallGroup.name}.
                        </SheetDescription>
                    </SheetHeader>
                    ...
                    <Card className="shadow-lg">
                        ...
                        <CardContent>
                            <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                                ...
                                {/* Graduate Small Group Information */}
                                <div className="space-y-4">
                                    <h4 className="text-md font-semibold text-foreground border-b pb-2">Group Details</h4>
